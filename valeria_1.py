...
from modulo_financeiro import renderizar_modulo_financeiro
...
# Navegação por Abas Principais (Incluída a Aba 7: Financeiro)
tab1, tab2, tab3, tab4, tab5, tab6, tab7 = st.tabs([
    "👤 Pessoas", "🏠 Imóveis", "📄 Contratos", "📊 Relatório", "📧 Alertas", "💬 Mensagens", "💲 Financeiro"
])
...
# ------------------------------------------------------------------------------
# ABA 7: ADMINISTRAÇÃO FINANCEIRA E COBRANÇA (Módulo Separado)
# ------------------------------------------------------------------------------
with tab7:
    renderizar_modulo_financeiro(API_URL)